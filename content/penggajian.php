				...
				<div class="card-body">
					...
					<form action="crud/simpan_gaji.php" method="POST">
						...
						<div class="row">
							<div class="col-sm-auto">
								<div class="form-inline">
									...
									<input type="date" id="tanggal" name="tanggal" class="form-control" value="<?php echo date('Y-m-d') ?>"  style="cursor: no-drop;">
						...
						<div class="row">
							<div class="col-sm-auto">
								<div class="form-inline">
									...
									<!-- Tgl -->
									<label for="absen" style="font-weight: normal;">Absen Masuk&nbsp;&nbsp;&nbsp;&nbsp;</label>
									<input type="text" id="absen" name="absen" class="form-control" readonly style="cursor: no-drop;">
									&nbsp;
									<!-- Tgl -->
									
									<label for="harian" style="margin-left: 40px; font-weight: normal;">Harian Pendapatan&nbsp;&nbsp;&nbsp;&nbsp;</label>
									<input type="text" id="harian" name="harian" class="form-control" readonly style="cursor: no-drop;">
						...
						<!-- <div class="row"> -->
							...
							<!-- <div class="col-sm-4">
								<div class="form-group">
								  <label for="masuk" class="col-form-label" style="font-weight: normal;">Absen Masuk</label>
									<input type="text" class="form-control" id="absen" name="absen"  required="" autocomplete="off">
								</div>
							</div> -->
						<!-- </div> -->
						<hr>
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<center><label for="ppn" style="font-weight: normal;">pendapatan kotor</label></center>
									<input type="text" name="ppn" id="ppn" class="form-control" autocomplete="off" readonly style="cursor: no-drop;">
									<input type="hidden" name="pendapatan_kotor" id="pendapatan_kotor" class="form-control" autocomplete="off" readonly style="cursor: no-drop;">

									<input type="hidden" name="jumlah_anak" id="jumlah_anak" class="form-control" autocomplete="off" readonly style="cursor: no-drop;">
									<input type="hidden" name="tunj_anak" id="tunj_anak" class="form-control" readonly style="cursor: no-drop;">
									<input type="hidden" name="tunj_istri" id="tunj_istri" class="form-control" autocomplete="off" readonly style="cursor: no-drop;">
									<input type="hidden" name="nama_golongan" id="nama_golongan" class="form-control" autocomplete="off" readonly style="cursor: no-drop;">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
