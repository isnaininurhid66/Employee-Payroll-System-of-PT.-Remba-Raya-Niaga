...
<body class="bg-light">
	<div class="container">
		...
		<h4 class="text-center">PT. REMBA RAYA NIAGA</h4>
		...
		<table class="table table-hover table-bordered">
			...
			<?php
			if(empty($_GET['key'])){
				$qr = $db->get("pegawai.nip,pegawai.absen,pegawai.alamat,pegawai.cabang,pegawai.nama,pegawai.tempat_lahir,pegawai.tanggal_lahir,jabatan.nama_jabatan,golongan.golongan,pegawai.status,pegawai.jumlah_anak","pegawai","INNER JOIN jabatan on pegawai.kode_jabatan=jabatan.kode_jabatan INNER JOIN golongan on golongan.kode_golongan=pegawai.kode_golongan ORDER BY pegawai.nip ASC");
			}else{
				$nama = $_GET['key'];
		...
		<br><br><br><br><br>
		<p style="float: left; margin-left: 60px;">SUGENG</p>
